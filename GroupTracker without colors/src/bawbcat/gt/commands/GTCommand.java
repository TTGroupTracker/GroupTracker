...
public class GTCommand extends Command {
    ...
    public boolean action(String message, String sender, String channel, GroupTracker bot) {
        ...
        if (bot.containsPhrase(message, "who made")) {
            bot.sendMessage(channel, Colors.NORMAL + "BawbCat" + Colors.NORMAL + " made me, " + Colors.NORMAL + sender + Colors.NORMAL + ". I was modified slightly by " + Colors.NORMAL + "Judge.");
            return true;
        }
        if (bot.contains(message, "version")) {
            bot.sendNotice(sender, Colors.NORMAL + Colors.NORMAL + "GroupTracker" + Colors.NORMAL + " is currently version " + Colors.NORMAL + Colors.NORMAL + bot.version + Colors.NORMAL + ".");
            return true;
        }
        if (bot.contains(message, "districts")) {
            ...
            for (String s : districts) {
                response = response + Colors.NORMAL + Colors.NORMAL + s + Colors.NORMAL;
        ...
        if (bot.contains(message, "enable")) {
            if (bot.ops.contains(sender)) {
                bot.sendNotice(sender, Colors.NORMAL + Colors.NORMAL + "GroupTracker" + Colors.NORMAL + " is already " + Colors.NORMAL + Colors.NORMAL + "enabled" + Colors.NORMAL + "!");
            }
        }
        if (bot.contains(message, "disable") || bot.contains(message, "toggle")) {
            if (bot.ops.contains(sender)) {
                bot.enabled = false;
                bot.sendNotice(sender, Colors.NORMAL + Colors.NORMAL + "GroupTracker" + Colors.NORMAL + " is now " + Colors.NORMAL + Colors.NORMAL + "disabled" + Colors.NORMAL + ".");
            }
        }
